...
- vi - editor mode : creates a file if filename doesn't exist and allows to write into the file.  
To save it press “Esc” key and “:wq” – to write and quit. Ex: vi filename.txt
