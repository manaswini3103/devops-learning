...
#service status `<name of the service>` : to check status of the service  
#service start `<name of the service>`  : to start the service  
#service stop `<name of the service>`   : to stop the service  
#service reload `<name of the service>` : to reload the service, reread the configuration of the service. Each service has at least one configuration.  
#service restart `<name of the service>` : to restart the service, stops the existing connections.  
