...
- If we edit in test1.txt it will be reflected in original test.txt also
...
- Hard links can be moved around the filesystem, and it doesn’t matter if the original file is moved, because it points to the data of the file instead of the file itself.
